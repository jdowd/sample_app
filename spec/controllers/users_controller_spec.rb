...
describe UsersController do
  ...
  describe "GET 'index'" do
    ...
    describe "for signed-in-users" do
      ...
      before(:each) do
        ...
        Factory(:user, :email => "example2@email.com")
        Factory(:user, :email => "example3@email.net")
  ...
  describe "GET 'show'" do
    ...
    it "should display the micropost count" do
      3.times { Factory(:micropost, :user => @user, :content => "foo") }
      get :show, :id => @user 
      # response.should have_selector('td.sidebar', :content => "3")
  ...
  describe "PUT 'update'" do
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = { :name => "New Name", :email => "newuser@email.com", 
  ...
  describe "DELETE 'destroy'" do
    ...
    describe "as an admin user" do
      ...
      it "should redirect to the users pager" do
        delete :destroy, :id => @user 
